      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative mb-16">
                      ...
                      <div>
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="text-gray-400">{testimonial.type} • {testimonial.role}</div>
                          </div>
                        </div>
                      </div>
          ...
          <div className="flex justify-center mt-8 space-x-4">
            <button 
              onClick={prevSlide}
              className="w-12 h-12 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center border border-white/20 transition-colors"
            >
        ...
        {/* Trust Badges */}
        <div className="text-center">
          <div className="text-gray-400 mb-8">Trusted by teams at</div>
